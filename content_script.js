...
removeCourses = () => {
	var filter = ["ORGANIZACIJA IN ARHITEKTURA RAČUNALNIKOV", "MATEMATIKA I VS", "OSNOVE ALGORITMOV", "PODATKOVNE STRUKTURE", "PROGRAMIRANJE I VS", "PROGRAMIRANJE II", "SODOBNA PROGRAMSKA ORODJA", "STROKOVNA ANGLEŠČINA", "UVOD V OPERACIJSKE SISTEME", "UVOD V RAČUNALNIŠTVO", "UVOD V SVETOVNI SPLET", "0 OSNOVE STATISTIKE", "PODATKOVNE BAZE - VS", "RAČUNALNIŠKA OMREŽJA", "RAZVOJ PROGRAMSKIH SISTEMOV", "UPORABNIŠKI VMESNIKI"]
